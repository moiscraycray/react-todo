...
This project uses [Flip Move](https://github.com/joshwcomeau/react-flip-move) for animations.
...
In your file that will be using the library, add the following `import` statement at the top:
```
